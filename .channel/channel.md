...
- **Hook + framing line.** Hook = devastating fact (NEVER a question), immediately followed by "You would not want to be in the [Event], [Year]." The framing line tells the cold viewer what this video is about and appears as on-screen text.
