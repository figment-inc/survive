...
def generate_storyboard(topic: str, year: str, editor_notes: Optional[str] = None) -> str:
    ...
    user_prompt = (
        ...
        "1. Header with title, total clips, runtime (target 45-50 seconds), format\n"
        "2. 8 clips organized into 5 narrative beats (The Hook, The Immersion, The Attempt, The Catastrophe, The Cliffhanger)\n"
        ...
        "4. All clips (HOOK and SCENE) have the skeleton character on camera — mix of 4s and 8s, 1080p for SCENE clips\n"
